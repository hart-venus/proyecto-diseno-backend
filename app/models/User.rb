...
class User
    ...
    attr_accessor :nombre_completo, :correo, :celular, :campus, :tipo, :password, :active, :id 

    CAMPUS_TYPES = %w[CA SJ LI AL SC].freeze
    USER_TYPES = %w[AsistenteAdmin Estudiante Profesor ProfesorCoordinador].freeze 
    validates :nombre_completo, :correo, :celular, :campus, :tipo, :password, :id, presence: true
